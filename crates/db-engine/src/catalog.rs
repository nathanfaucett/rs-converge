...
pub const ENGINE_TABLE_FIELD_TABLE_NAME: &str = "table_name";

pub const ENGINE_TABLE_FIELDS: &str = "table_fields";
pub const ENGINE_TABLE_FIELDS_FIELD_TABLE_NAME: &str = "table_name";
...
pub const ENGINE_INDEX_FIELDS_FIELD_INDEX_NAME: &str = "index_name";
